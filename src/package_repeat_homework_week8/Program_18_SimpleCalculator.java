...
public class Program_18_SimpleCalculator {
    ...
    public double getAdditionnResult(){
        return getFirstnumber() + getSecondnumber();
    }
    public double getsubtractionResult(){
        return getFirstnumber() - getSecondnumber();
    }
    public double getMultiplicatonResult(){
        return getFirstnumber() *getSecondnumber();
    }
    ...
    public static void main(String[] args) {
        ...
        calculator.setFirstnumber(5.0);
        calculator.setSecondnumber(4);
        System.out.println("add= " + calculator.getAdditionnResult());
        System.out.println("subtract= " + calculator.getsubtractionResult());
        calculator.setFirstnumber(5.25);
        calculator.setSecondnumber(0);
        System.out.println("multiply= " + calculator.getMultiplicatonResult());
        System.out.println("divide= " + calculator.getDivisionResult());
